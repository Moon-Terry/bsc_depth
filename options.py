...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--split",
                                 ...
                                 choices=["endovis", "eigen_zhou", "eigen_full", "odom", "benchmark", "dongintest", 'SCARED', 'endovis2', "PIPAC_train"],
                                 default="endovis")
        ...
        self.parser.add_argument("--eval_split",
                                 ...
                                 default="endovis",
                                 choices=[
                                    "eigen", "eigen_benchmark", "benchmark", "odom_9", "odom_10", "endovis", "SCARED", "endovis2", "PIPAC_test"],
